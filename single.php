...
function jsg_single_featured_image() {
	...
	<figure class="featured-image" style="background-image: url('<?php echo $background[0]; ?>'); background-position: center;"></figure>
  <? the_post_navigation();
  echo '<div class="wrap">';
}
	...
	*/
	...
	if ( have_posts() ) : 
		...
		while ( have_posts() ) : the_post(); 
			echo '<article class="post-' . $post->ID . ' entry" itemscope="" itemtype="http://schema.org/CreativeWork">';
